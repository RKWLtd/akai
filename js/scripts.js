(function($) {
    ...
    ---------------------*/
    $('.scroll-btn,.btn-scroll,.scroll-btn-nav').bind('click', function(event) {
        var $anchor = $(this);
